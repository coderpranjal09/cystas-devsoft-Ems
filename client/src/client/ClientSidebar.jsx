// src/client/ClientSidebar.jsx
import { Home, User, ClipboardList, CalendarCheck, Folder, LogOut, Menu, Award, TrendingUp } from 'lucide-react';
...
const ClientSidebar = () => {
  ...
  const navItems = [
    ...
    { name: 'My Performance', icon: TrendingUp, path: '/client/performance' }
  ];
      ...
      <Sheet>
        <SheetTrigger asChild className="lg:hidden">
          <Button 
            variant="outline" 
            size="icon" 
            className="fixed top-4 left-4 z-50 bg-gray-900 text-white hover:bg-gray-800 border-gray-700"
          >
