...
import { CheckCircle, Clock, Calendar as CalendarIcon, Folder, AlertCircle, Award, TrendingUp } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          {statCards.map((stat, index) => (
            <Link to={stat.link} key={index}>
              <Card className="bg-gray-800 border border-gray-700 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <div className="space-y-4">
                {tasks.length > 0 ? (
                  tasks.slice(0, 5).map(task => (
                    <Link to={`/client/tasks`} key={task._id}>
                      <div className="flex items-start border-b border-gray-700 pb-4 last:border-b-0 last:pb-0 hover:bg-gray-700/50 p-2 rounded transition-colors">
              ...
              <div className="space-y-4">
                {projects.length > 0 ? (
                  projects.slice(0, 3).map(project => (
                    <Link to={`/client/projects/${project._id}`} key={project._id}>
                      <div className="border-b border-gray-700 pb-4 last:border-b-0 last:pb-0 hover:bg-gray-700/50 p-2 rounded transition-colors">
